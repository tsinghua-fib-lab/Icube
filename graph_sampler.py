...
class GraphSampler(torch.utils.data.Dataset):
    ...
    def __init__(self, G_list, features='default', normalize=True, assign_feat='default', max_num_nodes=0):
        ...
        # if features == 'default':
        a = util.node_dict(G_list[0])
        a = a['0']['feat']
        self.feat_dim = a.shape[0]
        ...
        for G in G_list:
            ...
            self.adj_all.append(G.graph['case_num'])
    ...
    def __getitem__(self, idx):
        ...
        adj = sp.load_npz('../prediction_in_full_graph_with_aoi/GMNN_data/adjs/case_{0}.npz'.format(adj))
        adj = adj.toarray()
